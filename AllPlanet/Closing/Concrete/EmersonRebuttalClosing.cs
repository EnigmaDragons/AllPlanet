    ...
    public static class ClosingArgument1
    {
        public static ClosingArgument Argument { get; } = new ClosingArgument("emerson closing", TransitionFactory.Create("to second argument"), TransitionFactory.Create("lost to emerson"), 
            new ClosingChoice(new object[0],
                ...
                new ClosingOption("Throw shade at your opponent", +2, 
            ...
            new ClosingChoice(new object[0],
                ...
                new ClosingOption("planet made from", true, "You are made up of everything a planet is made up of", +1,
                    ...
                    new PlanetResponds("I am made up of Carbon Monoxide, Carbon Dioxide, Nitrogen, all the stuff planet's are made out of.", PlanetExpression.Challenging),
                ...
                new ClosingOption("planet made from 2", false, "You are made up of everything a planet is made up of", +2,
                    ...
                    new PlanetResponds("Just like a car, if I was to use 6 wheels instead of 4 would it still be a car?", PlanetExpression.Challenging),
                    new PlanetResponds("Of course it would be!", PlanetExpression.Proud),
                    new PlanetResponds("I am made up of Carbon Monoxide, Carbon Dioxide, Nitrogen, and even 199 Rexium, all the stuff planet's are made out of.", PlanetExpression.Proud),
                    new PlanetResponds("And I'm the shape of planet, and I orbit the sun. Therefore I am a planet.", PlanetExpression.Proud)),
            ...
            new ClosingChoice(new object[] { new PlanetResponds("In regards to Dr.Emerson", PlanetExpression.Challenging) },
                ...
                new ClosingOption("Question the legitimacy of a scientist who gets paid by private corporations", +2, 
                ...
                new ClosingOption("Emerson doesn't look like a scientist", +1, 
                    ...
                    new PlanetResponds("And those shoes, very business-y.", PlanetExpression.Thinking),
            ...
            new ClosingChoice(new object[0],
                ...
                new ClosingOption("unite", true, "Unite the audience against the common enemy", +1,
                    ...
                    new PlanetResponds("First it's claiming planet's aren't real, then it's going to be claiming you guys arn't real scientists.", PlanetExpression.Challenging),
                    new CrowdResponds(CrowdExpression.Boo),
                    new OpponentResponds("-", OpponentExpression.Worried)),
                new ClosingOption("unite 2", false, "Unite the audience against the common enemy", +2,
                    new PlanetResponds("Do you see Emerson's grin, he is thinking to himself that he is smarter than all of the audience.", PlanetExpression.Challenging),
                    new PlanetResponds("That he can pull one over this entire community, like he did with the entire scientific community!", PlanetExpression.Challenging),
                    new PlanetResponds("First it's claiming planet's aren't real, then it's going to be claiming you guys arn't real scientists.", PlanetExpression.Challenging),
                    new CrowdResponds(CrowdExpression.Boo),
                    new OpponentResponds("-", OpponentExpression.Worried)),
