        ...
        public static ClosingArgument Argument { get; } = new ClosingArgument("quinton closing", TransitionFactory.Create("victory"), TransitionFactory.Create("lost to quinton"),
            ...
            new ClosingChoice(new object[] { new PlanetResponds("I have something to say about quinton.", PlanetExpression.Challenging),  },
                ...
                new ClosingOption("Dr.Rocheford is Pluto", +3, 
                    ...
                    new PlanetResponds("Dr. Rocheford is PLUTO!", PlanetExpression.Challenging),
                    new PlanetResponds("In 2006 he was determined to not be a planet.", PlanetExpression.Challenging),
            ...
            new ClosingChoice(new object[] { new PlanetResponds("Ladies and gentlemen", PlanetExpression.Proud), },
                ...
                new ClosingOption("Free space flights", -1, 
                    ...
                    new PlanetResponds("We can go all around the solor system, show you all of the planets up close.", PlanetExpression.Proud),
                    new CrowdResponds(CrowdExpression.Cheer),
