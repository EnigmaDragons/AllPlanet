    ...
    public static class QuintonRochefordClosing
    {
        public static ClosingArgument Argument { get; } = new ClosingArgument("quinton closing", TransitionFactory.Create("victory"), TransitionFactory.Create("lost to quinton"),
            new ClosingChoice(new object[0], 
                ...
                new ClosingOption("Proud opening", 9,
                ...
                new ClosingOption("Pedantic opening", 9, 
            ...
            new ClosingChoice(new object[] { new PlanetResponds("Ladies and gentlemen", PlanetExpression.Proud), },
                new ClosingOption("A vote for me is a vote for the future", 0,
                    ...
                    new CrowdResponds(CrowdExpression.Cheer)),
                new ClosingOption("Free space flights", -1, 
                    new PlanetResponds("I will give you free tours around space!", PlanetExpression.Proud),
                    new PlanetResponds("We can go all around the solor system, show you all the planet's up close.", PlanetExpression.Proud),
                    new CrowdResponds(CrowdExpression.Cheer),
                    new OpponentResponds("You're going to accept bribes, well then I'm offering 1 million dollars to each of you if I win.", OpponentExpression.Proud),
                    new CrowdResponds(CrowdExpression.Cheer)),
                new ClosingOption("You are the greatest audience", +1,
                    new PlanetResponds("You are the greatest audience any planet could ask for.", PlanetExpression.Proud),
                    new PlanetResponds("You are incredibly intelligent and discerning, and I want to thank you for that.", PlanetExpression.Proud),
                    new CrowdResponds(CrowdExpression.Cheer))),
            new ClosingChoice(new object[] { new PlanetResponds("In conclusion", PlanetExpression.Challenging), },
                ...
                new ClosingOption("I just dropped on by to tell you I'm not a planet.", 9, 
                ...
                new ClosingOption("Dr.Rocheford must be stopped", +2,
                    ...
                    new PlanetResponds("Declaring I'm not a planet is just the next step in his evil plan!", PlanetExpression.Sad))));
    }
}
