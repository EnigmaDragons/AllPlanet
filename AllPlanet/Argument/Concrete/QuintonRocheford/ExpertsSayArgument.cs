    ...
    public static class ExpertsSayArgument
    {
        public static ArgumentPoint Argument { get; } = new ArgumentPoint(new List<object>
            ...
            new Statement("Experts defined what a planet is.", OpponentExpression.Challenging,
                new RefuteOption(ArgumentType.AppealToAuthority, "too far from sun", -1,
                ...
                new RefuteOption(ArgumentType.AppealToEmotion, "too far from sun", 0,
                ...
                new RefuteOption(ArgumentType.AgreeAndAmplify, "too far from sun", +3,
            ...
            new Statement("As such they are the ones who judge what belongs in the category of planet.", OpponentExpression.Challenging,
                new RefuteOption(ArgumentType.Discredit, "too far from sun", -2,
                ...
                new RefuteOption(ArgumentType.AdHominem, "too far from sun", +1,
                    ...
                    new OpponentResponds("I have been an accredited scientist for years. Everyone has heard of me. Of course I'm an expert.", OpponentExpression.Challenging),
                    new CrowdResponds(CrowdExpression.Cheer)),
                new RefuteOption(ArgumentType.Reframe, "too far from sun", +2,
            ...
            new Statement("All the experts have judged that you are not a planet!", OpponentExpression.Proud,
                new RefuteOption(ArgumentType.FakeStatistic, "too far from sun", +1,
                ...
                new RefuteOption(ArgumentType.AppealToAuthority, "too far from sun", -1,
                    ...
                    new CrowdResponds(CrowdExpression.NoComment)),
                new RefuteOption(ArgumentType.Reframe, "too far from sun", +1,
