...
namespace AllPlanet.Argument.Concrete.DrEmerson
{
    public static class IllegalSmugglerArgument
    {
        public static ArgumentPoint Argument { get; } = new ArgumentPoint(new List<object>
            ...
            "illegal smuggling",
            new Statement("\"Planet\" is an honorable title. But you are not an honorable planet, are you?", OpponentExpression.Challenging, GenericDiscreditResponse.Create("illegal smuggling"),
            ...
            new Statement("We caught and punished those smugglers, but we never judged you for your involvement in holding onto those weapons.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("illegal smuggling"),
                ...
                new RefuteOption(ArgumentType.AdHominem, "legit scientist", 0, 
                    ...
                    new CrowdResponds(CrowdExpression.NoComment))),
            new Statement("Ladies and gentlemen, I plead with you! Don't let some lawbreaking entity tarish what a planet is.", OpponentExpression.Worried, GenericDiscreditResponse.Create("illegal smuggling"),
