        ...
        public static ArgumentPoint Argument { get; } = new ArgumentPoint(new List<object>
            {
                ...
                new OpponentResponds("Being a planet is an honorable title. But you are not an honorable planet are you?", OpponentExpression.Challenging),
                ...
                new OpponentResponds("I plead with the audience don't let some lawbreaking entity, tarish what a planet is.", OpponentExpression.Worried),
                ArgumentLearnedFactory.Create(ArgumentType.Discredit),
                ArgumentLearnedFactory.Create(ArgumentType.AdHominem),
            },
            "illegal smuggling",
            new Statement("Being a planet is an honorable title. But you are not an honorable planet are you?", OpponentExpression.Challenging, GenericDiscreditResponse.Create("illegal smuggling"),
            ...
            new Statement("You have been involved in smuggling illegal weapons to warmongers.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("illegal smuggling"),
               ...
               new RefuteOption(ArgumentType.FakeStatistic, "emerson rebutal", +2,
                   ...
                   new CrowdResponds(CrowdExpression.Cheer))),
            new Statement("We caught and punished those smugglers, but we never judged you for your involvement in holding onto those weapons.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("illegal smuggling"),
                new RefuteOption(ArgumentType.AppealToEmotion, "emerson rebutal", -2,
                ...
                new RefuteOption(ArgumentType.AdHominem, "legit scientist", 0, 
                    ...
                    new CrowdResponds(CrowdExpression.NoComment))),
            new Statement("I plead with the audience don't let some lawbreaking entity, tarish what a planet is.", OpponentExpression.Worried, GenericDiscreditResponse.Create("illegal smuggling"),
                new RefuteOption(ArgumentType.AdHominem, "legit scientist", +1,
                    ...
                    new CrowdResponds(CrowdExpression.NoComment)),
                new RefuteOption(ArgumentType.StrawMan, "emerson rebutal", +2,
