...
namespace AllPlanet.Argument.Concrete.DrEmerson
{
    public static class LegitScientistArgument
    {
        public static ArgumentPoint Argument { get; } = new ArgumentPoint(new List<object>
            ...
            "legit scientist",
            new Statement("I am a legitimate scientist because of all these creditentials I have.", OpponentExpression.Proud, GenericDiscreditResponse.Create("legit scientist"),
            ...
            new Statement("I also discovered element 199 Rexium.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("legit scientist"),
                new RefuteOption(ArgumentType.AppealToAuthority, "emerson rebutal", +2, 
            ...
            new Statement("I have given millions of speeches, in every scientific community.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("legit scientist"),
                new RefuteOption(ArgumentType.AgreeAndAmplify, "emerson rebutal", 0,
                ...
                new RefuteOption(ArgumentType.AdHominem, "emerson rebutal", +1, 
                    ...
                    new CrowdResponds(CrowdExpression.NoComment))),
            new Statement("No one can dispute my legitimacy.", OpponentExpression.Proud, GenericDiscreditResponse.Create("legit scientist"),
                new RefuteOption(ArgumentType.AppealToAuthority, "emerson rebutal", 0, 
