...
namespace AllPlanet.Argument.Concrete.DrEmerson
{
    public static class BornInLondonArgument
    {
        public static ArgumentPoint Argument { get; } = new ArgumentPoint(new List<object>
            ...
            "born in london", 
            new Statement("I have with me some irrefutable evidence that you are not a planet.", OpponentExpression.Challenging,
                ...
                new RefuteOption(ArgumentType.AgreeAndAmplify, "illegal smuggling", -1, 
                    new PlanetResponds("Oh, it's irrefutable. No one could ever defeat it in a million years!", PlanetExpression.Challenging),
                    new PlanetResponds("It's the holy evidence thou shalt not refute.", PlanetExpression.Sad),
                    new PlanetResponds("All science is based around this proof.", PlanetExpression.Challenging),
                    new OpponentResponds("Well I don't hear you refuting it!", OpponentExpression.Proud),
                    new CrowdResponds(CrowdExpression.NoComment))),
            new Statement("Here is your birth certificate.", OpponentExpression.Proud,
                new RefuteOption(ArgumentType.Reframe, "fake certificate", 1, 
                ...
                new RefuteOption(ArgumentType.Illegitimize, "fake certificate", 2,
                    ...
                    new CrowdResponds(CrowdExpression.Cheer),
                    new OpponentResponds("I will prove that this is yours!", OpponentExpression.Worried)),
                new RefuteOption(ArgumentType.Refuse, "fake certificate", 0, 
                    ...
                    new CrowdResponds(CrowdExpression.NoComment))),
            new Statement("It says here you were born in London.", OpponentExpression.Proud,
                new RefuteOption(ArgumentType.Refuse, "illegal smuggling", -3, 
                ...
                new RefuteOption(ArgumentType.Illegitimize, "illegal smuggling", -1, 
                    ...
                    new CrowdResponds(CrowdExpression.NoComment))),
            new Statement("Now I think it is safe to say, no planet can be born in london.", OpponentExpression.Challenging,
                ...
                new RefuteOption(ArgumentType.FakeStatistic, "illegal smuggling", -1,
                    ...
                    new CrowdResponds(CrowdExpression.NoComment)),
                new RefuteOption(ArgumentType.Reframe, "illegal smuggling", 3, 
