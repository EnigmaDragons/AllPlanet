...
namespace AllPlanet.Argument.Concrete.DrEmerson
{
    public static class BornInLondonArgument
    {
        public static ArgumentPoint Argument { get; } = new ArgumentPoint(new List<object>
            ...
            "born in london", 
            new Statement("I have with me some irruftuable evidence that you are not a planet.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("born in london"),
            ...
            new Statement("Here is your birth certificate.", OpponentExpression.Proud, GenericDiscreditResponse.Create("born in london"),
                new RefuteOption(ArgumentType.Reframe, "fake certificate", 2, 
                    new PlanetResponds("You have read that wrong.", PlanetExpression.Challenging),
                    new PlanetResponds("That is my diploma for getting a masters in astronomy from oxford.", PlanetExpression.Proud),
                ...
                new RefuteOption(ArgumentType.Illegitimize, "fake certificate", 3, 
                    new PlanetResponds("Now your buying random birth certificates off of craigslist with the same name as me.", PlanetExpression.Challenging),
            ...
            new Statement("It says here you were born in london.", OpponentExpression.Proud, GenericDiscreditResponse.Create("born in london"),
                new RefuteOption(ArgumentType.Refuse, "emerson rebutal", -3, 
                    ...
                    new OpponentResponds("Are you questioning a great scientists ability to read?", OpponentExpression.Proud),
                    new CrowdResponds(CrowdExpression.Boo)),
                new RefuteOption(ArgumentType.Illegitimize, "emerson rebutal", -1, 
                    ...
                    new PlanetResponds("And on a tabloid I read that I came from south africa.", PlanetExpression.Challenging),
            ...
            new Statement("Now I think it is safe to say, no planet can be born in london.", OpponentExpression.Challenging, GenericDiscreditResponse.Create("born in london"),
                new RefuteOption(ArgumentType.AppealToEmotion, "emerson rebutal", 2, 
                    ...
                    new PlanetResponds("I could bare to see them starve themselves, so in the middle of the night I left them to go orbit the sun.", PlanetExpression.Sad),
